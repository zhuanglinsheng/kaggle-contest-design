...
&\quad\prod_{k=0}^{N-1}\phi\left(\hat{y}_{t_{k+1}}-\hat{y}_{t_k}|\int_{t_k}^{t_{k+1}}m_i(\tilde{y}_s, s) - m_j(\tilde{y}_s, s)ds, \sigma^2(t_{k+1}-t_k)+\frac{1}{\Delta\lambda}\right)
\end{aligned}
\end{equation}
