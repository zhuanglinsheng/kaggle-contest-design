...
\midrule
 Posterior Mean    & 1.078 & 1.727 & 14.588 & 2.759 & 1.090 & 0.062 \\
 Posterior Stderr   & 0.381 & 0.655 & 3.894 & 0.494 & 0.297 & 4.981 \\
 RMSE                  & 0.400 & 0.693 & 3.916 & 0.905 & 0.310 & 4.981 \\
 95\% Interval        
		& [0.54, 2.00] 
		& [0.76, 3.33]
		& [7.8, 22.8]
...
Posterior Mean  & 1.112 & 1.508 & 13.774 & 1.974 & 1.081 & 0.239 \\
Posterior Stderr & 0.335 & 0.466 & 3.984 & 0.145 & 0.128 & 5.168 \\
RMSE               & 0.347 & 0.466 & 4.168 & 0.148 & 0.151 & 5.174 \\
\addlinespace
...
Posterior Mean    & 0.736 & 0.914 & 15.606 & 1.944 & 0.959 & 0.173\\
Posterior Stderr   & 0.177 & 0.240 & 3.358 & 0.205 & 0.152 & 4.948\\
RMSE                  & 0.223 & 0.291 & 3.412 & 0.213 & 0.158 & 4.951\\
\addlinespace
\multicolumn{5}{l}{\textbf{Contest of 12 Months}} \\
True Value           & 0.3     & 0.375 & 15.0 & 2.0     & 1.0     & 0.0\\
Posterior Mean    & 0.259 & 0.383 & 12.692 & 0.949 & 1.034 &\\
...
{\footnotesize
\textit{Note:} (1) $\text{MSE}(\hat\theta) = \mathbb{E}(\hat{\theta}-\theta)^2 = [\mathbb{E}(\hat{\theta}) - \theta]^2 + Var(\hat{\theta})$ by the bias–variance decomposition. RMSE is then calculate by the squared root of MSE. 
(2) Players $i$ and $j$ submit 59 and 51 times in the 6-month contest, and 154 and 90 times in the 12-month contest, respectively.
}
\end{minipage}
\end{table}
