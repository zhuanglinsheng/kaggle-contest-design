...
{\color{red}
It is important to note that, since our analysis relies on normality assumptions which heavily relies on the form of data transformation (\ref{eq-leaderboard-transform}). 
We conduct a series of normality tests on the sample points $(\hat{y}_t^c - y_t^c)$ for each contest $c$.
}
