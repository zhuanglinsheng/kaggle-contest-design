...
In our Bayesian framework, we specify truncated normal distributions with large variances as priors for the unknown parameters $c_i$, $c_j$, $\sigma$ and $\lambda$.  
...
\subsection{Asymptotic Convergence under Replicated Experiments}

...

\subsection{Long Term Asymptotic Convergence}
