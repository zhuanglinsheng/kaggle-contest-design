...
\begin{minipage}[t]{0.53\textwidth}
	...
	\begin{tabularx}{\textwidth}{llYY}
		...
		\midrule
		const.
		& -0.718 & 3.184 & [-7.064, 5.627] \\
		$\log(1 + \hat{\lambda})$ 
		& 3.259\textbf{**} & 1.089 & [1.089, 5.429] \\
		\midrule
		Obs. & \multicolumn{3}{c}{75} \\
		R$^2$ & \multicolumn{3}{c}{0.109} \\
		Adj. R$^2$ & \multicolumn{3}{c}{0.097} \\
		\bottomrule
		\addlinespace[0.5ex]
	\end{tabularx}
	\begin{minipage}{\textwidth}
...
(2) Normality diagnostics: Omnibus = 0.376, Jarque-Bera = 0.070, Skewness = $-0.041$, Kurtosis = 3.125. 
