...
% estimation
Using only contest-phase information observable to participants, we recover key latent components—including perceived competition, effort dynamics, individual abilities, innovation uncertainty, and signal precision.
% validation
...
% platforms
Platforms such as Kaggle, Topcoder, DrivenData, and AIcrowd host thousands of these contests, attracting data scientists, engineers, and developers to compete by submitting solutions to real-world problems.
% how kaggle runs
...
% Contest structure
The design of these contests involves significant strategic complexity, as participants make repeated decisions in a dynamic environment shaped by evolving information, shifting incentives, and the actions of competitors. 
...
Structural Estimation - \cite{jiang2022role}.
...
Specifically, when $c_i = c_j$, we have 
\begin{equation}
