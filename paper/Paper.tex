...
An additional assumption underlying the data-generating process pertains to the assumption that leaderboard data follow a normal distribution.
...
\begin{minipage}[t]{0.53\textwidth}
	...
	\begin{tabularx}{\textwidth}{llYY}
		...
		R$^2$ & \multicolumn{3}{c}{0.115} \\
		Adj. R$^2$ & \multicolumn{3}{c}{0.103} \\
		\bottomrule
		\addlinespace[0.5ex]
	\end{tabularx}
	\begin{minipage}{\textwidth}
